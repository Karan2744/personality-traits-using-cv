...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
    ...
    # Check if the specific word is in the text
    if "TECHINCAL KNOWLEGDE" in text:
        print("Found the word!")
    
    result=Tk()
  #  result.geometry('700x550')
  
    img = PhotoImage(file="C://Users//Admin//Desktop//Personality-Prediction-Through-CV-master//Snapshots//3. Result Page.png")
    label = Label(result, image=img)
    label.place(x=0, y=0)
